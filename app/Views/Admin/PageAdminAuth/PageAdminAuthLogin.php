...
<html
  ...
  <head>
    ...
    <title>Login - Admin | SKJ Admission</title>
    ...
    <link rel="stylesheet" href="<?= base_url('public/sneat-assets/vendor/fonts/iconify-icons.css') ?>" />
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="<?= base_url('public/sneat-assets/vendor/css/pages/page-auth.css') ?>" />
          ...
          <div class="card px-sm-6 px-0">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="<?= base_url('new-admission') ?>" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">SKJ Admission</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-1">เข้าสู่ระบบด้วย Google! 👋</h4>
              <p class="mb-6">กรุณาเข้าสู่ระบบด้วยบัญชี Google ของคุณเพื่อใช้งาน</p>
