...
<style>
    ...
    .photo-preview-wrapper:hover .photo-edit-btn { opacity: 1; }
    ...
    .doc-preview-container i { font-size: 3rem; color: #adb5bd; }
    ...
    .actions-card p { color: rgba(255,255,255,0.7); }
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-label-primary fs-6 py-2 px-3">Student ID: <?= $recruit['recruit_id'] ?></span>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light fw-bold" value="<?= $recruit['recruit_year'] ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select fw-bold status-badge-select" name="recruit_status" required>
                                        ...
                                        <option value="ไม่ผ่านการตรวจสอบ" <?= strpos($recruit['recruit_status'], 'ไม่ผ่าน') !== false ? 'selected' : '' ?> class="text-danger">❌ ไม่ผ่านการตรวจสอบ</option>
                                    </select>
                                </div>
                            </div>

                            <div class="col-12">
                                <label class="form-label">ประเภทโควตา / รอบการสมัคร <span class="text-danger">*</span></label>
                                ...
                                <div class="course-select-row">
                                    <div id="course_selection_container">
                                        <div class="mb-3 row align-items-center">
                                            <label class="col-sm-3 col-form-label fw-bold text-dark">อันดับที่ 1 <span class="text-danger">*</span></label>
                                            <div class="col-sm-9 text-center">
                                                ...
                                                <small class="text-primary mt-1 d-block"><i class='bx bx-star me-1'></i>แผนการเรียนหลักสำหรับใช้ประมวลผล</small>
                                            </div>
                                        </div>

                                        <div class="mb-3 row align-items-center border-top pt-3">
                                            <label class="col-sm-3 col-form-label fw-semibold text-muted">อันดับที่ 2</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row align-items-center border-top pt-3">
                                            <label class="col-sm-3 col-form-label fw-semibold text-muted">อันดับที่ 3</label>
                                            <div class="col-sm-9">
                    ...
                    <div class="card-body pt-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control" name="recruit_firstName" value="<?= esc($recruit['recruit_firstName']) ?>" required>
                            </div>
                            <div class="col-md-5">
                                <label class="form-label">นามสกุล <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="recruit_lastName" value="<?= esc($recruit['recruit_lastName']) ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="recruit_idCard" value="<?= esc($recruit['recruit_idCard']) ?>" maxlength="13" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="date" class="form-control" name="recruit_birthday" value="<?= esc($recruit['recruit_birthday']) ?>" required>
                                </div>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">เชื้อชาติ</label>
                                <input type="text" class="form-control" name="recruit_race" value="<?= esc($recruit['recruit_race'] ?? 'ไทย') ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">สัญชาติ</label>
                                <input type="text" class="form-control" name="recruit_nationality" value="<?= esc($recruit['recruit_nationality'] ?? 'ไทย') ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">ศาสนา</label>
                                <input type="text" class="form-control" name="recruit_religion" value="<?= esc($recruit['recruit_religion'] ?? 'พุทธ') ?>">
                            </div>

                            <div class="col-md-12">
                                <label class="form-label">เบอร์โทรศัพท์สำหรับติดต่อ <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text"><i class='bx bx-phone-call'></i></span>
                                    <input type="tel" class="form-control" name="recruit_phone" value="<?= esc($recruit['recruit_phone']) ?>" required placeholder="08XXXXXXXX">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-4">
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="recruit_homeNumber" value="<?= esc($recruit['recruit_homeNumber'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">หมู่ที่ <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="recruit_homeGroup" value="<?= esc($recruit['recruit_homeGroup'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-7">
                                <label class="form-label">ถนน / ซอย</label>
                                <input type="text" class="form-control" name="recruit_homeRoad" value="<?= esc($recruit['recruit_homeRoad'] ?? '') ?>">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="recruit_homeSubdistrict" id="recruit_homeSubdistrict" value="<?= esc($recruit['recruit_homeSubdistrict'] ?? '') ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">อำเภอ / เขต <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="recruit_homedistrict" id="recruit_homedistrict" value="<?= esc($recruit['recruit_homedistrict'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">จังหวัด <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="recruit_homeProvince" id="recruit_homeProvince" value="<?= esc($recruit['recruit_homeProvince'] ?? '') ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold font-monospace">รหัสไปรษณีย์ <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text"><i class='bx bx-navigation'></i></span>
                                    <input type="text" class="form-control fw-bold" name="recruit_homePostcode" id="recruit_homePostcode" value="<?= esc($recruit['recruit_homePostcode'] ?? '') ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4 profile-card">
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid">
                            <button type="button" class="btn btn-primary" onclick="document.getElementById('recruit_img').click()">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="recruit_district" id="recruit_district" value="<?= esc($recruit['recruit_district'] ?? '') ?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label small">จังหวัดที่ตั้ง</label>
                                <input type="text" class="form-control" name="recruit_province" id="recruit_province" value="<?= esc($recruit['recruit_province'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" step="0.01" min="0" max="4.00" class="form-control fw-bold" name="recruit_grade" value="<?= esc($recruit['recruit_grade']) ?>" required>
                            </div>
                        </div>

                        <div class="mb-0">
                            <label class="form-label text-muted small">สาขาวิชา / แผนการเรียนเดิม</label>
                            <input type="text" class="form-control bg-lighter" name="recruit_major" value="<?= esc($recruit['recruit_major'] ?? '') ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card actions-card mb-5">
                    <div class="card-body p-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-4 text-center text-md-start">
                        <div>
                        ...
                        <div class="d-flex gap-3 w-100 w-md-auto">
                            <a href="<?= site_url('skjadmin/recruits/view/' . $recruit['recruit_id']) ?>" class="btn btn-outline-light px-4 flex-grow-1 flex-md-grow-0">
                                <i class='bx bx-undo me-2'></i> ยกเลิก
                            </a>
                            <button type="submit" form="editForm" class="btn btn-success px-5 flex-grow-1 flex-md-grow-0 py-3 shadow-lg">
